...
namespace CryptoLib
{
    ...
    {
        public static string Encode(string data, string alphabet,int columns, int rows,string key, out string generatedTable)
        {
